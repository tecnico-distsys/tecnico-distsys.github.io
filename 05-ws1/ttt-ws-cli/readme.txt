...
To run using appassembler plugin:
  On Windows:
    target\appassembler\bin\ttt-ws-cli.bat http://localhost:8080/ttt-ws/endpoint
  On Linux:
    ./target/appassembler/bin/ttt-ws-cli http://localhost:8080/ttt-ws/endpoint
